...
use App\Tasks\SwitchCacheStoreTask;
use App\Tasks\SwitchFilesystemTask;
...
return [
    ...
    /*
     * These domains will be used to access the central application
     */
    'central_domains' => [
        '127.0.0.1',
    ],
    ...
    'not_tenant_aware_jobs' => [
        ...
        App\Jobs\CreateTenantDirectory::class,
        App\Jobs\DeleteTenantDatabase::class,
        App\Jobs\DeleteTenantDirectory::class,
    ],
];
